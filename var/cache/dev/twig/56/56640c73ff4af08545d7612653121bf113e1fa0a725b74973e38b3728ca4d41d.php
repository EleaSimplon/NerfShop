...
class __TwigTemplate_d78c9b55086a8dd6bb1aef22a4fcf3e70f6de18bf8904c83e984cc8d952adfcd extends Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["paiement"]) {
            ...
            echo "</td>
                <td>";
            // line 22
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["paiement"], "commande", [], "any", false, false, false, 22), "html", null, true);
            echo "</td>
                <td>";
            // line 23
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["paiement"], "adresseFacturation", [], "any", false, false, false, 23), "html", null, true);
            echo "</td>
                <td>";
            // line 24
...
{% endblock %}
", "paiement/index.html.twig", "/home/simplon/devilbox/data/www/NerfShop/htdocs/templates/paiement/index.html.twig");
    }
}
