...
class Produit extends \App\Entity\Produit implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Produit' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Produit' . "\0" . 'prix', '' . "\0" . 'App\\Entity\\Produit' . "\0" . 'nomProduit', '' . "\0" . 'App\\Entity\\Produit' . "\0" . 'img', '' . "\0" . 'App\\Entity\\Produit' . "\0" . 'textPromo', '' . "\0" . 'App\\Entity\\Produit' . "\0" . 'prixPromo'];
        }
    ...
    public function getTextPromo(): ?string
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getTextPromo', []);

        return parent::getTextPromo();
    }

    /**
     * {@inheritDoc}
     */
    public function setTextPromo(?string $textPromo): \App\Entity\Produit
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setTextPromo', [$textPromo]);

        return parent::setTextPromo($textPromo);
    }
     ...
     * {@inheritDoc}
     */
    public function setPrixPromo(?int $prixPromo): \App\Entity\Produit
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setPrixPromo', [$prixPromo]);

        return parent::setPrixPromo($prixPromo);
    }
